    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="card">
                    <article class="card-body">
                        <h4 class="title">Добро пожаловать в <?=$profile->name_magazin?></h4>
        ...
        <div class="row row-sm mb-3">
            <aside class="col-md-3">
                ...
                <?php  $directoryAsset = Yii::$app->assetManager->getPublishedUrl('@app/views/shop/');?>
                <?= $this->render(
                    'category.php',
                    ['directoryAsset' => $directoryAsset, 'profile'=>$profile, 'category'=>$category, 'searchModel'=>$searchModel]
                ) ?>
