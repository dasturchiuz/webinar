...
<div class="card card-filter">
                ...
                <ul class="nav-category">
                    <?php foreach ($data as $item): ?>
                        ...
                        <?php if (count($item['childs']) > 0): ?>
                            <li class="has-submenu"> <?= Html::a($item['name'] . ' <i class="icon-arrow-right pull-right"></i>', ['product/category/' . $item['slug']]) ?>
                                <ul class="menu-more">
                                    <?php foreach ($item['childs'] as $childs): ?>
                                        <li> <?= Html::a($childs['name'], ['product/category/' . $childs['slug']]) ?></li>
                                    <?php endforeach; ?>
                                </ul>
                            </li>
                        <?php else: ?>
                            <li>
                                <?= Html::a($item['name'], ['product/category/' . $item['slug']]) ?>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </ul>
    ...
    <?php endif; ?>
    <?php $form = \yii\widgets\ActiveForm::begin(['method' => 'get', 'action' => ['/product/index'],]); ?>
    <article class="card-group-item">
        <header class="card-header">
