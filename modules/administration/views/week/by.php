            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'label'=>'Не было заказчика',
                        'format'=>'html',
                        'value'=>function($model)  use($week_num){
                            return
                                Html::a('<i class="fa fa-eye" aria-hidden="true"></i>', ['/administration/no-customers/clientby', 'client_id'=>$model->user_id], ['class'=>'btn btn-primary', 'title'=>'Просмотр'])." ".
                                Html::a('<i class="fa fa-exclamation-circle" aria-hidden="true"></i>', ['/administration/no-customers/no-customer-comment', 'client_id'=>$model->user_id, 'week_number'=>$week_num], ['class'=>'btn btn-info', 'title'=>'Не заказал'])." ".
                                Html::a('<i class="fa fa-user-times" aria-hidden="true"></i>', ['/administration/no-customers/set-no-customer', 'client_id'=>$model->user_id, 'week_number'=>$week_num], ['class'=>'btn btn-danger', 'title'=>'Заказчика не было'])
;
                        }
                    ],
