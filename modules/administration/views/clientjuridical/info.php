...
if($model->juridic!=null){
    $this->title = $model->juridic->orgon->name." \"".$model->juridic->tashkilot."\" - ".$model->user->user_id;
}else{
    $this->title = $model->user->user_id;
}
                ...
                <div class="box-body">
                    ...
                    <?= DetailView::widget([
                        ...
                        'attributes' => [
                            ...
                            [
                                'attribute'=> 'brand_juridical',
                                'format'=>'raw',
                                'value'=>function($model){
                                    return $model->juridic->brand_juridical != null ? $model->juridic->brand_juridical : "" ;
                                }
                            ],
                            'vipstatus',
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <p>
                            <?= Html::a(Yii::t('app', 'Редактировать ' ), ['/administration/clientjuridical/edit', 'profile_id'=>$model->user_id], ['class' => 'form-control btn btn-warning']) ?>
                        </p>
                        <p>
                    ...
                    <div class="col-md-6">
                        ...
                        <p>
                            <?= Html::a(Yii::t('app', 'Долг'), ['/administration/history-order/debt-history', 'profile_id' => $model->user_id], ['class' => 'form-control btn btn-danger']) ?>
                        </p>
                        <?php if(\app\models\config\Ruxsatnoma::isHuquqRahbariyat() || Yii::$app->user->can('super_admin')):?>
                            <p>
