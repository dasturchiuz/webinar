                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if(isset($model->courier->user_id))
                                    echo Html::encode( "<strong>". $model->courier->user_id. $model->courier->lastname." <strong>");
                                else
                ...
                <table class="table table-bordered">
                    ...
                    <?php foreach($model->orderItems as $id => $item):?>
                        <tr>
                            <td>
                                <figure class="media">
                                    <div class="img-wrap"><img src="<?=$item->product->getImage()->getUrl("128x");?>" class="img-thumbnail img-sm"></div>
