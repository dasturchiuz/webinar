...
$this->title = "Офоримть доставка №".$model->id." в долг";
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <div class="col-md-6">
                ...
                <?=$form->field($modelForm, 'date')->widget(DatePicker::classname(),[
                    'language'=>'ru',
            ...
            <div>
                <p>бла бла бла бла бла  <?=number_format($model->sum, 2, ',', ' ')?> оформить в долг бла бла бла бла бла </p>
            </div>
