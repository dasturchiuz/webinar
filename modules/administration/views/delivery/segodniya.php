...
$this->title = 'Физических и юридических лиц - Доставить сегодня';
    ...
    <div class="box box-primary">
        ...
        <div class="box-body" id="datagridvie">
            ...
            <div class="row">
                ...
                <div class="col-md-2"><?= $form->field($model, 'order_id')->hiddenInput(['value'=>''])->label(false) ?><p id="zakaznomer"></p></div>
                ...
                <div class="col-md-5 text-right">
                    ...
                    ?>
                    <?= $form->field($model, 'comment_text')->textArea(['rows'=>1, 'placeholder'=>'комментарий'])->label(false) ?>

                    <?= Html::submitButton('Доставить на дату', ['class' => 'btn btn-primary']) ?>
                    <?= Html::a('Доставить завтра', ['#'], ['class' => 'btn btn-success', 'id'=>'dastavitzavtra']) ?>

                    <?= Html::a('Оформить заявку', ['#'], ['class' => 'btn btn-info']) ?>
            ...
            $this->registerJs('
                    ...
                    aa.attr("class", "success");
                      ...
                      if ($box.is(":checked")) {
                        ...
                        var link="/administration/delivery/deliver-tomorrow?order_id="+$box.val();
                        $("#dastavitzavtra").attr("href", link);
